...
# ==============================================================================
st.title("🛡️ Експертен Анализатор на Храни")
st.write("Сканирайте продукт и приложението ще ви каже дали се съдържат вещества като: Е-номера, мазнини, захари и алкохоли.")
